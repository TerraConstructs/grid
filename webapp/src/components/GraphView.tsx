...
function GraphViewContent({
  ...
  return (
    <div className="w-full bg-gray-50 flex flex-col">
      <div className="max-w-7xl mx-auto p-4 w-full flex-shrink-0">
        <LabelFilter
          onFilterChange={onFilterChange}
          initialFilters={activeFilters}
        />
      </div>
      <div className="flex-1 px-4 pb-4 max-w-7xl mx-auto w-full min-h-0 flex">
        <div className="bg-white rounded-lg shadow flex-1 relative">
          ...
          >
            ...
            {/* Edge Status Legend */}
            <Panel position="bottom-left" className="bg-white rounded-lg shadow-lg p-3 space-y-1.5">
