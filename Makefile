...
test-e2e: build ## Run E2E tests (webapp authentication flows with Playwright)
	@echo "Running E2E tests..."
	@echo "Note: This will start all required services (postgres, keycloak, gridapi, webapp)"
	@pnpm test:e2e

test-e2e-ui: build ## Run E2E tests in interactive UI mode
	@echo "Starting E2E tests in UI mode..."
	@pnpm test:e2e:ui

test-e2e-headed: build ## Run E2E tests in headed mode (visible browser)
	@echo "Running E2E tests in headed mode..."
	@pnpm test:e2e:headed

test-e2e-debug: build ## Run E2E tests in debug mode
